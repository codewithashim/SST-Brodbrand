                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col col-sm-12 col-md-6">
                                                        <div class="form-group">
                                                            <label>Client Route MAC :</label>
                                                            <textarea class="form-control h-100 w-100" rows="10" cols="50" readonly>{{ $customer->address }}</textarea>
                                                        </div>
                                                    </div>

                                                </div>
                                                <form action="{{ route('customer.inactive',$customer->id) }}" method="post">
                                                  @csrf
                                                  ...
                                                  @enderror
                                                  <button class="btn btn-sm btn-primary" type="submit">Reactive</a>
                                                </form>
                                            </div>
                                        </div><!-- /.modal-content -->
                                    </div><!-- /.modal-dialog -->
