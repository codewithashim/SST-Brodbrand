...
<div class="container-fluid">
    @if (Auth::user()->type != 3)    
        <div class="row bg-muted p-3 mb-3">
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box">
                    <h4 class="header-title mt-0 m-b-30">Total Due Customer</h4>
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1">
                            <i class="fas fa-user-tie" style="font-size: 50px"></i>
                        </div>
                        <div class="widget-detail-1 text-center">
                            <h2 class="mb-0" id="due_customers"> {{ $due_customers  }} </h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card-box">
                    <h4 class="header-title mt-0 m-b-30">Total Company Bill</h4>
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1">
                            <span style="font-size: 50px"> ৳ </span>
                        </div>
              ...
              <div class="col-xl-3 col-md-6">
                <div class="card-box">
                    <h4 class="header-title mt-0 m-b-30">Total Admin Bill</h4>
                    <div class="widget-chart-1">
                        <div class="widget-chart-box-1">
                            <span style="font-size: 50px"> ৳ </span>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card-box">
                    ...
                    <div class="table-responsive">
                        <table id="datatable-inactive" class="table  table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th class="align-middle text-center">Sl.</th>
                            <th class="align-middle text-center">Name</th>
            ...
            <div class="col-12">
                <div class="card-box">
                    <div class="mt-0 m-b-30 d-flex justify-content-between">
                        <h4 class="header-title">Due Customer</h4>
                        <a href="{{ route('sendmessage') }}" class="btn btn-primary">Send Reactive Message To All</a>
                    </div>

                    <div class="table-responsive">
                        <table id="datatable-duecustomar" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr>
                            <th class="align-middle text-center">Sl.</th>
                            <th class="align-middle text-center">Name</th>
                            ...
                            <th class="align-middle text-center">Phone</th>
                            <th class="align-middle text-center">Net ID</th>
                            <th class="align-middle text-center">Due Amount</th>
                            <th class="align-middle text-center">Due Month</th>
                            <th class="align-middle text-center">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($duecustomers as $customer)
                            <tr>
                                ...
                                <td class="align-middle text-center">{{ $customer->month }}</td>
                                <td class="align-middle text-center">
                                    <a href="{{ route('sendmessage.single',$customer->id) }}" class="btn btn-primary">Send Reactive Message</a>
                                </td>
                            </tr>
                 ...
                 $('#form_btn').on('click',function(){
                    ...
                    $.ajax({
                        ...
                        success : function (data) {
                            ...
                            document.getElementById('due_customers').innerHTML = data['due_customers'];
